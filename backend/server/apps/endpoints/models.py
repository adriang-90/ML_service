...
class MLAlgorithm(models.Model):
    """
    The MLAlgorithm represet the ML algorithm object.
    
    Attributes:
    name: The name of the algorithm,
    description: The short description of how the algorithm works,
    code: The code of the algorithm,
    version: Te version of the algorithm similiar to software versioning,
...
class MLAlgorithmStatus(models.Model):
    ...
    Attributes:
        ...
        parent_mlaglorithm: The refence to corresponding MLAlgorithm.
     """
